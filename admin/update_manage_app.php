...
if (isset($_POST['submit'])) {
    ...
    $sql = "update `apps` set app_name='$appname',category='$appcatogary',app_description='$appdescription',price='$appPrice'  where blog_id=$id";    
    $result = mysqli_query($conn, $sql);
    if ($result) {
                ...
                <div class="left">
                    <div class="form">
                        ...
                        <select id="catogary" name="appcatogary">
                            ...
                            <option value="Games" <?php if ($category == 'Games')
                        ...
                        <textarea name="appdescription" id="description" cols="30"
                            rows="2"><?php echo $appdescription; ?></textarea><br><br>

                        <label><b style="font-size: 15px">Price :</b></label><br>
                        <div class="wrapper">
                            <input type="radio" name="appprice" value="Free" id="app-option-1" <?php if ($appPrice == 'Free')
                                echo 'checked'; ?>>
                            <input type="radio" name="appprice" value="Paid" id="app-option-2" <?php if ($appPrice == 'Paid')
                                echo 'checked'; ?>>
